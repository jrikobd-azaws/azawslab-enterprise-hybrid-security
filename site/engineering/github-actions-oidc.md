...
| Keep plan and apply as separate control points | Terraform plan output is reviewed before apply, preventing unreviewed infrastructure mutation. | [Terraform state and pipeline map](https://github.com/jrikobd-azaws/azawslab-enterprise-hybrid-security/blob/main/docs/release2/11-terraform-state-and-pipeline-map.md) |
