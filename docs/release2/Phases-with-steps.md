...
For this project, P2b is executed from the workspace / Codespace environment rather than the normal local editing workflow. This keeps Ansible-related work in a controlled Linux environment.
